    ...
    <div className="login-page">
      <div className="login-card">
        <div className="login-logo">
          <img src={LOGO} alt="HBC La Fillière" style={{ width: 100, height: 100, objectFit: 'contain' }} />
        </div>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          <div className="form-group">
            ...
            <input type="email" className="form-input" value={email} onChange={e => setEmail(e.target.value)} placeholder="tresorier@club.fr" required autoFocus />
          </div>
          <div className="form-group">
        ...
        <p style={{ marginTop: 16, fontSize: 11, color: 'var(--gray-400)', textAlign: 'center' }}>Accès réservé au trésorier du club</p>
      </div>
    </div>
  )
}
